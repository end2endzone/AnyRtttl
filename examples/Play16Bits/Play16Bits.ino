...
#define SIZE_IN_NOTES(array_var) ( (SIZE_IN_BYTES(array_var) - sizeof(anyrtttl::RTTTL_CONTROL_SECTION)) / sizeof(anyrtttl::RTTTL_NOTE))
...
const int notes_count = SIZE_IN_NOTES(tetris16);
